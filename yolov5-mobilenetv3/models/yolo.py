...
def SummeryModel(model, imgsz: int = 640):
    ...
    macs_content = "{:<19} = {:>8.3f}G".format("Overall MACs (FVCore)**", flops_fvcore)
    print(macs_content)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--cfg", type=str, default="yolov5-mobilenetv3\models\yolov5s-MobileNetV3-2.yaml", help="model.yaml")
